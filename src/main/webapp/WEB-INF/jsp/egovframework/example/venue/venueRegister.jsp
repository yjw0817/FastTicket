...
<form:form commandName="venueVO" id="detailForm" name="detailForm">
    <div id="content_pop">
        <!-- 타이틀 -->
        <div id="title">
            <ul>
                <li><img src="<c:url value='/images/egovframework/example/title_dot.gif'/>" alt=""/>
                    <c:if test="${registerFlag == 'create'}">공연장 등록</c:if>
                    <c:if test="${registerFlag == 'modify'}">공연장 수정</c:if>
                </li>
            </ul>
        </div>
        <!-- // 타이틀 -->
        <div id="table" class="table-responsive">
            <table class="table" style="border-top:2px solid #C2D0DB; border-collapse:collapse;">
                ...
                <c:if test="${registerFlag == 'modify'}">
                    <tr>
                        <td class="tbtd_caption"><label for="venueId">공연장ID</label></td>
                ...
                <tr>
                    <td class="tbtd_caption"><label for="venueNm">공연장명</label></td>
                    <td class="tbtd_content">
