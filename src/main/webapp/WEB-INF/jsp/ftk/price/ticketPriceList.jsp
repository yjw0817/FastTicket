...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_addView() {
            location.href = "<c:url value='/addTicketPrice.do'/>";
        }
                ...
                <table class="table table-hover table-striped" summary="가격ID, 프로그램, 가격유형, 가격명, 가격, 사용여부 표시하는 테이블">
                    ...
                    <c:forEach var="result" items="${resultList}" varStatus="status">
                        <tr>
                            ...
                            <td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.priceId}"/>')"><c:out value="${result.priceId}"/></a></td>
                            <td align="left" class="listtd"><c:out value="${result.programNm}"/>&nbsp;</td>
                            <td align="center" class="listtd"><c:out value="${result.priceType}"/>&nbsp;</td>
                            <td align="left" class="listtd"><c:out value="${result.priceNm}"/>&nbsp;</td>
