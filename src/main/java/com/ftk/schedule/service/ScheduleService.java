...
public interface ScheduleService {
	...
	List<String> selectAvailableDates(String programId);

	List<ScheduleVO> selectAvailableSessions(String programId, String eventDate);

	int decreaseOnlineAvail(String scheduleId, int qty);

	/** 달력 뷰: 월별 일정 요약 */
	List<?> selectCalendarSummary(String programId, String yearMonth);

	/** 달력 뷰: 날짜별 상세 */
	List<?> selectDateDetail(String programId, String eventDate);

	/** 달력 뷰: 날짜별 가격 */
	List<?> selectDatePrices(String programId, String eventDate, int sessionNo, String dayType);

	/** 날짜별 가격 override 저장 */
	void saveDatePriceOverride(Map<String, Object> param);

	/** 날짜별 가격 override 삭제 */
	void deleteDatePriceOverride(Map<String, Object> param);

	/** 날짜별 회차 override 저장 */
	void saveDateSessionOverride(Map<String, Object> param);
